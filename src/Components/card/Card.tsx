...
//           <h5 className="mb-0" style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
//             {title}
//           </h5>
...
//           <div className="ms-auto text-warning">{<Rating rate={rating} />}</div>
//         </div>
//       </div>
//       <button className="btn btn-info mb-2 align-self-center w-50" onClick={handleAddToCart}>
//         Add to Cart
//       </button>
//     </div>
//   );
